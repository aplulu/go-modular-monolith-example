...
const (
	ArticleService_ListArticle_FullMethodName = "/example.article.v1.ArticleService/ListArticle"
)
...
type ArticleServiceClient interface {
	// ユーザを取得
	ListArticle(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListArticleResponse, error)
}
...
func (c *articleServiceClient) ListArticle(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListArticleResponse, error) {
...
type ArticleServiceServer interface {
	// ユーザを取得
	ListArticle(context.Context, *emptypb.Empty) (*ListArticleResponse, error)
}
...
func (UnimplementedArticleServiceServer) ListArticle(context.Context, *emptypb.Empty) (*ListArticleResponse, error) {
...
func _ArticleService_ListArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).ListArticle(ctx, req.(*emptypb.Empty))
	}
...
var ArticleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.article.v1.ArticleService",
	...
	Metadata: "example/article/v1/article.proto",
}
